	...
	<view class="Community">
		<view class="Community_centent">
			<view class="Community_centent_flex" v-for="(item, index) in list" :key="index">
				<view class="flex_list" @click="openUstdLink(item.linkurl)">
		...
		<!-- <view class="explain">
			...
			<view class="explain_centent padding" style="color: rgb(237, 28, 36);">
				<rich-text :nodes="config.community_note"></rich-text>
			</view>
		</view> -->
	</view>
</template>
	...
	export default {
		...
		methods: {
			loadData() {
				...
				_this.helper.post('community/getCommunity',{}, function(res) {
					// console.log(res)
