		...
		<view class="form-content">
			<u-form :model="form" ref="uForm" :border="true">
				<u-form-item label-position="top" label="Encrypted problem" prop="question">
					<u-input :value="question" :disabled="true" placeholder=""/>
				</u-form-item>
				...
				<u-form-item label-position="top" label="Withdrawal password" prop="password">
					<u-input v-model="form.password" type="password" placeholder="Please enter your new withdrawal password" />
				</u-form-item>
			</u-form>
			<view class="padding">
			...
			return {
				...
				rules: {
					...
					password:[
						{
							required:true,
							message: 'Please enter your new withdrawal password',
						},
						{
		...
		methods: {
			sure(){
				...
				this.$refs.uForm.validate(valid => {
					if (valid) {
						console.log('验证通过');
						_this.helper.post("user/updateCashPassword",_this.form,function(res){
							uni.showToast({
