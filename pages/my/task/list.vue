<template>
	<view>
		<view style="text-align: center;padding: 20upx;">
			<image src="../../../static/jqr.png" style="height:200upx;" mode="heightFix"></image>
		</view>
		<view class="text-center bg-white">
			<view class="flex text-bold padding-tb">
				<view class="flex-sub">Earnings</view>
	...
	export default {
		...
		methods: {
			loadData(){
				...
				_this.helper.post('account/logs',{page:_this.p,type:42}, function(res) {
					var data = res.data;
					var list  = res.data;
